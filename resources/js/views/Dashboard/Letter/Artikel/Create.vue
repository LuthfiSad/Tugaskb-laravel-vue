        ...
        <div class="card-body">
          ...
          >
            ...
            <div class="form-group">
              ...
              <img
                :src="imgPreview"
                width="300" style="max-width: 100%;"
                class="mb-2"
                v-if="imgPreview"
                alt=""
              />
              <button v-if="artikel.image || imgPreview" type="button" class="btn btn-sm btn-dark p-2 ms-sm-2" v-on:click="defaultImg">Hapus Gambar</button>
              <input
                id="image"
                name="image"
                type="file"
  ...
  methods: {
    async formOnSubmit() {
      ...
      try {
        ...
        if (this.artikel.image) {
          formData.append("image", this.artikel.image);
        }
        // console.log(formData);
        const user = await axios.post("artikel", formData);
        (this.artikel = {
          title: "",
          deskripsi: "",
          id_kategori: "",
