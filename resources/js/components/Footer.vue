<template>
  <section class="contact-details" id="contact-details-section">
    <div class="col-12 col-md-12 col-lg-12 grid-margin text-center">
      <img :src="assetUrl + 'assets/images/HIMTI.png'" height="75" width="75" alt="" class="pb-2">
  ...
  <footer class="border-top">
    <p class="text-center text-muted pt-4">Copyright © 2023<a href="#" class="px-1">Kelompok Belajar Web Development HIMTI-UMT</a>.
    </p>
  </footer>
</template>
